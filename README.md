...
4) Класс Basket  
Класс для отображения корзины на странице, экстендит EventEmitter для инициации событий, связанных с элементами корзины.  
...
5) Класс BasketItem  
Класс для отображения добавленного итема в корзину, экстендит EventEmitter для инициации событий, связанных с элементами итема.  
...
6) Класс BasketPage  
Класс для отображения элемента корзины на странице магазина, экстендит EventEmitter для инициации событий. Содержит такие поля как:  
...
7) Класс Card  
Класс для отображения каталога карточек на странице и отображения карточки с полным описанием при открытии превью, экстендит EventEmitter для инициации событий, связанных с элементами карточки.  
...
8) Класс FormAddress  
Класс для отображения элементов формы адреса, экстендит EventEmitter для инициации событий, связанных с элементами формы.  
...
Класс для отображения элементов формы контактов, экстендит EventEmitter для инициации событий, связанных с элементами формы.  
...
10) Класс Succsess  
Класс для отображения сообщения об успешной оплате товаров, экстендит EventEmitter для инициации событий, связанных с элементами данного окна.  
